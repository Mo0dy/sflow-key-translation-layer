 ...
 *
 */
public class SFlowBaseVisitor extends BaseTypeVisitor<SFlowChecker> {

	public SFlowBaseVisitor(SFlowChecker checker, CompilationUnitTree root) {
		super(checker, root);
	}
...
//		return super.visitAnnotation(node, p);
	 ...
	 *
	 */
    protected class ConfidentialityTypeValidator extends BaseTypeVisitor<SFlowChecker>.TypeValidator {
